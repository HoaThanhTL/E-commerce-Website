...
class OrderDAOTest {
    ...
    final void testCreateProductOrder() {
        ...
        order.setDeliFirstName("Thanh Phuong");
        order.setDeliLastName("Nguyen");
        order.setDeliPhone("123456789");
        order.setDeliNumberHouse("373 Ly Thuong Kiet");
        order.setDeliStreet("1A Vo Van Ngan");
        order.setDeliDistrict("Ho Chi Minh");
        order.setDeliCity("Ho Chi Minh");
        order.setDeliZipCode("700000");
        order.setDeliCountry("US");
    ...
    final void testCreateProductOrder2() {
        ...
        order.setCustomer(customer);
        order.setDeliFirstName("Nam");
        order.setDeliLastName("Ha Minh");
        order.setDeliPhone("123456789");
        order.setDeliNumberHouse("53 Ngo Tat To");
        order.setDeliStreet("25 Huynh Thuc Khang");
        order.setDeliDistrict("Ho Chi Minh");
        order.setDeliCity("Ho Chi Minh");
        order.setDeliZipCode("700000");
        order.setDeliCountry("VN");
    ...
    final void testUpdateProductOrderShippingAddress() {
        ...
        order.setDeliNumberHouse("New Shipping Address");

        orderDAO.update(order);

        ProductOrder updatedOrder = orderDAO.get(orderId);

        assertEquals(order.getDeliNumberHouse(), updatedOrder.getDeliNumberHouse());
    }
    ...
    final void testGetOrder() {
        Integer orderId = 1;
        ProductOrder order = orderDAO.get(orderId);
        System.out.println(order.getDeliFirstName());
        System.out.println(order.getDeliLastName());
        System.out.println(order.getDeliPhone());
        System.out.println(order.getDeliNumberHouse());
        System.out.println(order.getDeliStreet());
        System.out.println(order.getDeliDistrict());
        System.out.println(order.getDeliCity());
        System.out.println(order.getDeliCountry());
        System.out.println(order.getDeliZipCode());
