...
public class PaymentService {
	...
	private ShippingAddress getRecipientInformation(ProductOrder order) {
		...
		shippingAddress.setRecipientName(order.getDeliFullName());
		shippingAddress.setPhone(order.getDeliPhone());
		shippingAddress.setLine1(order.getDeliNumberHouse());
		shippingAddress.setLine2(order.getDeliStreet());
		shippingAddress.setCity(order.getDeliDistrict());
		shippingAddress.setState(order.getDeliCity());
		shippingAddress.setCountryCode(order.getDeliCountry());
		shippingAddress.setPostalCode(order.getDeliZipCode());
