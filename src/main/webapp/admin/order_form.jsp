                    ...
                    <div class="card-body">
                        <form action="update_order" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control form-control-line" type="text" name="deliFirstName"
                                           value="${order.deliFirstName}" size="45" required="required"
                                           maxlength="32"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control form-control-line" type="text" name="deliLastName"
                                           value="${order.deliLastName}" size="45" required="required"
                                           maxlength="32"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control form-control-line" type="number" name="deliPhone"
                                           value="${order.deliPhone}" size="45" required="required"
                                           maxlength="16"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Number House</label>
                                <div class="col-md-12">
                                    <input class="form-control form-control-line" type="text"
                                           name="deliNumberHouse" value="${order.deliNumberHouse}" size="45"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control form-control-line" type="text"
                                           name="deliStreet" value="${order.deliStreet}" size="45"
                                           required="required" maxlength="128"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control form-control-line" type="text" name="deliDistrict"
                                           value="${order.deliDistrict}" size="45" required="required" maxlength="32"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">City</label>
                                <div class="col-md-12">
                                    <input class="form-control form-control-line" type="text" name="deliCity"
                                           value="${order.deliCity}" size="45" required="required"
                                           maxlength="32"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control form-control-line" type="number" name="deliZipCode"
                                           value="${order.deliZipCode}" size="45" required="required"
                                           maxlength="16"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control form-control-line" name="deliCountry"
                                            required="required">
                                        <c:forEach items="${mapCountries}" var="country">
                                            <option value="${country.value}"
                                                    <c:if test="${order.deliCountry eq country.value}">selected="selected"</c:if>>${country.key}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
