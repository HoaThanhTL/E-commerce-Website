                        ...
                        <c:if test="${customer != null}">
                            <form action="update_customer" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control form-control-line" type="text" name="street"
                                               size="45" value="${customer.numberHouse}" required="required"
                                               maxlength="128"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control form-control-line" type="text" name="street"
                                               size="45" value="${customer.street}" required="required"
                                               maxlength="128"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-control form-control-line" type="text" name="district" size="45"
                                               value="${customer.district}" required="required" maxlength="32"/>
                                    </div>
                                </div>
                                <div class="form-group">
